...
import AddStudent from '../../Components/Papers/StudentPapers/AddStudent';
import RemoveStudent from '../../Components/Papers/StudentPapers/RemoveStudent';
import UpdateStudent from '../../Components/Papers/StudentPapers/UpdateStudent';
        ...
        <Drawer variant="permanent" open={open}>
          ...
          >
            ...
            <Grid container spacing={3}>
              <Grid item xs={4}>
              <img src="./Images/CATS_Logo2v2.png" style={{ float: "left", cursor:"url(), pointer"}}
              onClick={(e) => {
                e.preventDefault();
