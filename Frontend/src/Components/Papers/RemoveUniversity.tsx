...
function FormInput(props:FormProps){
    ...
    const alertDialog = () =>{
        if(deleteCon?.openDialog) return( <AlertDialog id={text}/> ); 
    }
    ...
    return(
        <Grid container spacing={0} sx={{paddingTop:"5px", position:"relative"}}>
            ...
            <Grid item xs={12}>
                <button style={ButtonStyling} onClick={btnOnClick}>Remove university</button>
            </Grid>
            <Grid item xs={12}>
                {divErrorMessage()}
            </Grid>
        ...
        >
            <div style={{padding: "15px", paddingTop:"5px"}}>
                <Grid container spacing={0}>
                    ...
                    <Grid item xs={12}>
                        <DescriptionDiv message={"Deletes/Removes a university from the database"} fontSize={"15px"}/> 
                    </Grid>
                </Grid>
